...
{
    public class DarkConnectionSqlSever
    {
        #region Propiedades
        ...
        public DarkConnectionSqlSever()
        {

        }
        public DarkConnectionSqlSever(string ConnectionString)
        {
        ...
        public void StartInsert(string statement, List<ProcedureModel> DataModel)
        {
            ...
            {
                throw new DarkExceptionSystem(string.Format("SqlException - {0} - {1}", Evaluando, ex.Message));
            }
        }
